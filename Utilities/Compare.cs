        ...
        public static bool CompareObjects<T>(T expectInput, T actualInput)
        {
            ...
            if (expectInput is IEnumerable)
            {
                ...
                while (canGetExpectMember && canGetActualMember && true)
                {
                    ...
                    object isEqual = typeof(Compare).GetMethod("CompareObjects").MakeGenericMethod(currentType).Invoke(null, new object[] { expectEnumerator.Current, actualEnumerator.Current });
            ...
            foreach (var property in properties)
            {
                ...
                object isEqual = typeof(Compare).GetMethod("CompareObjects").MakeGenericMethod(property.PropertyType).Invoke(null, new object[] { expectValue, actualValue });
